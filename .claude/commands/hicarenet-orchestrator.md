...
> **References**: Design system spec and page architecture documents are available at `.claude/skills/hicarenet-orchestrator/references/` (`design-system-spec.md` and `page-architecture.md`).
